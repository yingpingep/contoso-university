...
namespace contoso_university.Migrations
{
    ...
    [Migration("20200815012212_Add_DateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("contoso_university.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("contoso_university.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("contoso_university.Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("contoso_university.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("contoso_university.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("contoso_university.Models.Person", "Student")
                        .WithMany("Enrollment")
